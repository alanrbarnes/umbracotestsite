...
namespace UdemyTestSite.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public void SendContactNotificationToAdmin(ContactFormViewModel vm)
        {
            ...
            SendMail(fromAddress, toAddresses, subject, htmlContent, textContent, siteSettings);
        ...
        public void SendVerifyEmailAddressNotification(string membersEmail, string verificationToken)
        {
            ...
            //Send the Email
            SendMail(fromAddress, membersEmail, subject, htmlContent, textContent, siteSettings);
        }

        //A generic send mail that logs the email in umbraco and sends via smtp
        private void SendMail(string fromAddresses, string toAddresses, string subject, string htmlContent, string textContent, IPublishedContent siteSettings)
        {
            //get site settings
            //var siteSettings = _umbracoHelper.ContentAtRoot().DescendantsOrSelfOfType("siteSettings").FirstOrDefault();
